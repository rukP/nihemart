...
export async function labelOrder(
  ...
  return {
    ...
    is_labeled: response.isLabeled !== undefined ? response.isLabeled : response.is_labeled,
  } as Order;
}
...
export async function removeOrderLabel(orderId: string): Promise<Order> {
  ...
  return {
    ...
    is_labeled: response.isLabeled !== undefined ? response.isLabeled : (response.is_labeled !== undefined ? response.is_labeled : false),
  } as Order;
}
