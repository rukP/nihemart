         ...
         >
            ...
            {/* <Script
              ...
              (function() {
                ...
                var MAX_RELOADS = 3; // Allow 3 reloads: normal -> hard -> force
                var RELOAD_DELAY = 300;
                var ERROR_UI_KEY = 'chunk-error-ui-shown';
                var LAST_RELOAD_TIME_KEY = 'last-chunk-reload-time';
                var OVERLAY_SHOWN_KEY = 'chunk-overlay-shown-time';
                
                function shouldReload() {
                  var reloadCount = parseInt(sessionStorage.getItem(RELOAD_KEY) || '0', 10);
                  var lastReloadTime = parseInt(sessionStorage.getItem(LAST_RELOAD_TIME_KEY) || '0', 10);
                ...
                function clearReloadFlag() {
                  ...
                  setTimeout(function() {
                    ...
                    var lastOverlayTime = parseInt(localStorage.getItem(OVERLAY_SHOWN_KEY) || '0', 10);
                ...
                function handleChunkError(source, url) {
                  ...
                  if (!shouldReload()) {
                    ...
                    console.error('Chunk error persisted after ' + MAX_RELOADS + ' reloads. Showing error UI.');
