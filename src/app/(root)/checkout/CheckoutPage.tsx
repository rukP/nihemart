...
const CheckoutPage = ({
  ...
  const clearAllCheckoutClientState = () => {
    ...
    try {
      ...
      console.error("[clearAllCheckoutClientState] Failed to clear cart:", e);
    }
  ...
  useEffect(() => {
    ...
    if (isLoggedIn) {
      ...
      try {
        ...
        console.error("Error clearing temp address:", e);
      }
      return;
    }
  ...
  const handleUpdateTempAddress = (addressData: any) => {
    ...
    try {
      ...
      console.error("Error saving temp address:", e);
    }
    // Update form data
    setFormData((prev) => ({
      ...prev,
  ...
  useEffect(() => {
    try {
      ...
      console.error("CheckoutPage: Error syncing/restoring cart items:", err);
    }
  ...
  const handlePaymentSuccess = (orderId: string) => {
    ...
    try {
      ...
      console.error("Failed to clear buy now item:", e);
    }
                            ...
                            onKeyDown={(e) => {
                              if (e.key === "Enter") {
                                ...
                                if (foundSector) {
                                  ...
                                  const foundDistrict = districts.find(
                                    (d) =>
                                      d.dst_id === foundSector.sct_district,
                                  );
                                  if (foundDistrict)
                                    setSelectedProvince(
                                      foundDistrict.dst_province,
              ...
              <OrderItemsList
                ...
                onRemove={(it) => {
                  try {
                    ...
                    console.error("Failed to remove checkout item:", e);
                  }
                }}
              />
