  ...
  useEffect(() => {
    const loadProduct = async () => {
      try {
        ...
        const subcategoryIds = productData.subcategoryIds || 
        ...
        const formattedData = {
          ...
          mainImages: productData.mainImages || productData.images?.filter((img: any) => !img.productVariationId) || [],
        ...
        const errorMessage = error?.message || error?.error || "Failed to load product";
