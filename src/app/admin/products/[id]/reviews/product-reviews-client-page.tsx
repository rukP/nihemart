...
import { deleteReview } from "@/lib/api/products";
...
export default function ProductReviewsClientPage({
  productName,
  initialReviews,
}: ProductReviewsClientPageProps) {
            ...
            {reviews.length > 0 ? (
              reviews.map((review) => (
                ...
                >
                  <Avatar>
                    <AvatarFallback>
                      {review.author?.full_name?.charAt(0) || "A"}
                    </AvatarFallback>
                  </Avatar>
