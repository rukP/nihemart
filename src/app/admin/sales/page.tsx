...
import { getSalesMetrics, getSalesChartData, getSalesByCategory, getTopProducts, getSalesByRegion } from "@/lib/api/sales";
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {product.unitsSold} units sold · {product.orders} orders
                          </p>
                        </div>
                      </div>
