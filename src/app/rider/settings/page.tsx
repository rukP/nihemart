...
import { useUpdateRider, useUpdateMyAvailability } from '@/hooks/useRiders';
...
export default function RiderSettingsPage() {
  ...
  const [_fullName] = React.useState('');
  const [_phone] = React.useState('');
  const [_vehicle] = React.useState('');
  const [active, setActive] = React.useState<boolean>(false);

  const _getInitials = (nameOrEmail: string) => {
  ...
  const _updateRider = useUpdateRider();
  const updateMyAvailability = useUpdateMyAvailability();
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-16 h-16 rounded-xl shadow-lg bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center overflow-hidden">
                      <UserAvatarProfile
                        className="w-16 h-16"
                        user={{
                          fullName: rider?.fullName || user?.email || 'Rider',
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={rider?.vehicle || ''} onValueChange={() => {}}>
                    ...
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-600">
                          Toggle your availability to receive new delivery
                          assignments
                        </p>
                      </div>
                    </div>
                    <div className="flex-shrink-0">
                      ...
                      <Switch
                        ...
                        onCheckedChange={async v => {
                          ...
                          try {
                            setSaving(true);
                            await updateMyAvailability.mutateAsync(!!v);
                            toast.success(
                              v
                ...
                <div className="pt-4">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 flex items-start gap-3">
                    ...
                    <p className="text-xs text-yellow-700">
                      Editing has been disabled for riders. If you need to
                      update your profile, please contact support or an admin.
                    </p>
                  </div>
                </div>
              </CardContent>
