                                 ...
                                 >
                                    <div className="flex justify-between">
                                       <div className="flex-1">
                                          ...
                                          {item.refund_status && (
                                             <span className={`inline-block mt-2 px-2 py-1 rounded-md text-xs font-semibold ${
                                                item.refund_status === 'approved' ? 'bg-green-100 text-green-700' :
                                                item.refund_status === 'rejected' ? 'bg-red-100 text-red-700' :
                                                item.refund_status === 'requested' ? 'bg-blue-100 text-blue-700' :
                                                'bg-gray-100 text-gray-700'
                                             }`}>
                                                {item.refund_status === 'approved' ? '✓ Refund Approved' :
                                                 item.refund_status === 'rejected' ? '✗ Item Rejected' :
                                                 item.refund_status === 'requested' ? '⏱ Refund Requested' :
