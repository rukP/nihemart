...
const RiderNotificationsPage = () => {
  ...
  useEffect(() => {
    ...
    // Also normalize createdAt -> created_at if needed
    const validNotifications = notifications
      .map((n: any) => ({
        ...n,
        created_at: n.created_at || n.createdAt, // Normalize field name
      }))
      .filter(n => {
  ...
  const handleDismiss = (notificationId: string) => {
    setLocalNotifications(prev => prev.filter(p => p.id !== notificationId));
              ...
              >
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will permanently delete all notifications and cannot
                      be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
