...
const Page = () => {
  ...
  const { data: feeAdjustments } = useMyFeeAdjustments(100);
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50">
      <ScrollArea className="h-[calc(100vh-2rem)]">
        <div className="mx-auto p-6">
          ...
          {/* Fee Adjustments Info Banner */}
          {feeAdjustments && feeAdjustments.length > 0 && (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      {feeAdjustments.slice(0, 3).map((adj: any) => {
                    ...
                    {feeAdjustments.length > 3 && (
                      <p className="text-xs text-blue-600 mt-2">
                        +{feeAdjustments.length - 3} more adjustment
                        {feeAdjustments.length - 3 !== 1 ? 's' : ''}
                      </p>
                    )}
                  </div>
                </div>
