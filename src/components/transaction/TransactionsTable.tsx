...
const TransactionsTable: FC<TransactionsTableProps> = () => {
   ...
   const initialPaymentMethod =
      searchParams?.get("payment_method") || undefined;
   ...
   const getPaymentMethodLabel = (method?: string) => {
      ...
      if ((PAYMENT_METHODS as any)[method])
         return (
                           ...
                           >
                              ...
                              <SelectContent>
                                 ...
                                 <SelectItem value="cash_on_delivery">
                                    {t(
                                       "payment.method.cash_on_delivery.name",
                                    ) || "Cash on Delivery"}
                                 </SelectItem>
                              </SelectContent>
                           </Select>
