      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="mt-3 text-sm text-center text-zinc-600">
            <p>
              Check your inbox and spam folder for the reset email. If you don't
              receive it in a few minutes, try again or contact support.
            </p>
            <p className="mt-2">
              <Link href="/signin" className="text-brand-orange underline">
                {t('auth.backToSignIn')}
              </Link>
            </p>
          </div>
