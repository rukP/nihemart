                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-3">
                        <div className="relative w-10 h-10 bg-gray-100 rounded flex-shrink-0">
                          <Image
                            src={optimizeImageUrl(product.main_image_url ?? null, { width: 40, quality: 75 })}
                            alt={product.name}
                            fill
                    ...
                    <TableCell>
                      <div className="flex flex-wrap gap-1 max-w-[200px]">
                        {(() => {
                          // Handle both categories array and singular category
                          const categories = product.categories || [];
                          const primaryCategory = categories.length > 0 
                            ? categories[0] 
                            : (product.category ? { id: product.category.id || product.category_id, name: product.category.name } : null);
                          ...
                          return <span className="text-gray-500">Uncategorized</span>;
                        })()}
                      </div>
                    </TableCell>
