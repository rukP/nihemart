...
import { Star, TrendingUp, MessageSquare, BarChart3, MoreHorizontal, RefreshCw } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function ReviewsOverview({ onTabChange }: { onTabChange?: (tab: string) => void }) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-white border-l-4 border-l-orange-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">{metrics.totalReviews}</div>
        ...
        <Card className="bg-white border-l-4 border-l-blue-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">{metrics.recentReviewsCount}</div>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">
              {metrics.totalReviews > 0
                ? Math.round(((metrics.ratingDistribution[5] || 0) / metrics.totalReviews) * 100)
                : 0}
              % of total
            </p>
          </CardContent>
          ...
          <CardContent>
            <ChartContainer config={ratingChartConfig}>
              <BarChart accessibilityLayer data={ratingChartData} height={200}>
                ...
                />
                <Bar dataKey="count" fill="var(--color-5)" radius={[2, 2, 0, 0]} />
              </BarChart>
            </ChartContainer>
          </CardContent>
        </Card>
                ...
                recentReviews.slice(0, 5).map((review) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        by {review.author?.full_name || review.user?.fullName || 'Anonymous'}
                      </p>
                    </div>
                  </div>
                ))
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Browse and manage all customer reviews</p>
              </div>
            </div>
            <Button
