...
const discountSchema = z
  .object({
    name: z
      .string()
      .min(2, 'Discount name must be at least 2 characters long.'),
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value={DiscountStatus.active}>
                        Active
                      </SelectItem>
                      <SelectItem value={DiscountStatus.inactive}>
                        Inactive
                      </SelectItem>
                      <SelectItem value={DiscountStatus.scheduled}>
                        Scheduled
                      </SelectItem>
                      <SelectItem value={DiscountStatus.expired}>
                        Expired
                      </SelectItem>
                    </SelectContent>
                  </Select>
