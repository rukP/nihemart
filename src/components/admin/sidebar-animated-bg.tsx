  ...
  return Children.map(children, (child: any, index) => {
    ...
    return cloneElement(
      ...
      <>
          ...
          {activeId === id && (
            <div className="w-full pl-2 absolute inset-0 top-0 h-10">
              <motion.div
                ...
                className={cn(
                  'h-full relative w-full after:content-[""] after:absolute after:h-full after:w-1 after:left-0 after:top-0 after:z-50 after:rounded-md after:bg-orange-500',
                  className
                )}
                transition={
        ...
        <div
          className={cn('z-10', ChildClasses, {
            'text-dumbOrange': activeId === id,
          })}
        >
