...
import { fetchRefundedDataForDashboard } from "@/lib/api/orders";
...
export default function RefundsOverview({
  ...
  // Read date range from URL search params so overview follows TimeFilter
  ...
  const computeDateRange = () => {
    // Default to today when no preset is provided
    if (!preset) {
      ...
      return {
        ...
        dateTo: formatLocalDate(tomorrow),
      };
    }

    if (preset === "all") return {} as any;
  ...
  const {
    ...
    queryKey: ["refunds-overview", range],
    queryFn: () => fetchRefundedDataForDashboard(range.dateFrom, range.dateTo),
  });
        ...
        <Card className="bg-gradient-to-r from-orange-50 to-orange-100 border-orange-200">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Manage Refunds</h3>
