...
import { MoreHorizontal, Eye, Trash2, UserCog, Mail, Phone, Calendar, ShoppingBag, DollarSign } from "lucide-react";
...
const ROLE_COLORS: Record<string, string> = {
  ...
  manager: "bg-purple-100 text-purple-800 border-purple-200 hover:bg-purple-200",
...
export const createCustomerColumns = (
  ...
  handleToggleAdmin?: (customerId: string, makeAdmin?: boolean) => Promise<void>,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const statusConfig = {
        ...
        VIP: { color: "bg-yellow-100 text-yellow-800 border-yellow-200", dot: "bg-yellow-500" },
      };
