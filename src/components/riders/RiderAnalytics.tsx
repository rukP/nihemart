...
import { Calendar, ArrowUp, TrendingUp } from 'lucide-react';
...
export function RiderAnalytics() {
  ...
  const totalDeliveries = deliveriesData.reduce(
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardFooter className="flex-col items-start gap-2 text-sm">
          <div className="flex gap-2 font-medium leading-none">
            Peak activity at {peakHour.time} with {peakHour.deliveries}{' '}
            deliveries <TrendingUp className="h-4 w-4 text-green-600" />
          </div>
