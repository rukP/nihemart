...
import { useAssignOrder } from '@/hooks/useRiders';
...
export default function AssignOrderToRiderDialog({
  ...
  const availableOrders = useMemo(() => {
    return Array.isArray(ordersQuery.data)
      ? ordersQuery.data
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="max-h-96 overflow-auto">
            ...
            {ordersQuery.isError && (
              <div className="p-4 text-red-500">Failed to load orders.</div>
            )}
          ...
          <DialogFooter>
            <div className="flex gap-2 justify-end w-full">
              ...
              <Button
                ...
                disabled={
                  assignMutation.status === 'pending' || !selectedOrderId
                }
              >
