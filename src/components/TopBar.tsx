    ...
    >
      ...
      >
        <div className="relative">
          <Input
            className="peer ps-10 border-none shadow-none h-12 md:min-w-80 md:text-base bg-surface-secondary rounded-full px-4 cursor-pointer"
          ...
          <div className="absolute inset-y-0 end-0 flex items-center pr-3 pointer-events-none">
            <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-background px-1.5 font-mono text-[10px] font-medium opacity-60">
