...
const Sidebar: FC<{ onMobile?: boolean; onLinkClick?: () => void }> = ({
  // onMobile = false,
  onLinkClick,
}) => {
  ...
  // const _fullName = user?.user_metadata?.full_name || user?.email || 'User';
  // const _role = roles.has('admin')
  //   ? 'Admin'
  //   : roles.has('manager')
  //     ? 'Manager'
  ...
  //         ? 'Staff'
  //         : 'User';
  // const _imageUrl = user?.user_metadata?.avatar_url || '';
