...
const Sidebar: FC<{ onMobile?: boolean }> = ({ onMobile = false }) => {
...
// Mobile-optimized version of Sidebar
const MobileSidebar: FC<{ onLinkClick?: () => void }> = ({ onLinkClick }) => {
  return <Sidebar onMobile={true} />;
};
