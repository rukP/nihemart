...
export default function PaymentInfoCard({
  ...
  const getPaymentMethodName = (method?: string | null) => {
    if (!method || typeof method !== 'string') return 'Unknown Payment Method';
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              {getPaymentMethodIcon(
                latestPayment.payment_method || orderPaymentMethod
              )}
          ...
          {orderRefundStatus && latestPayment.status === 'successful' && (
            <div className="mt-3 pt-3 border-t border-gray-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge
                  variant={
                    orderRefundStatus === 'approved' ? 'default' : 'secondary'
                  }
                  className="text-xs"
                >
              ...
              {orderRefundStatus === 'requested' && (
                <div className="bg-blue-50 border border-blue-200 rounded p-2 mt-2">
                  <p className="text-xs text-blue-800">
                    🔄 Your refund request is being reviewed. Once approved, the
                    refund will be processed back to your original payment
                    method.
                  </p>
                </div>
              )}
              ...
              {orderRefundStatus === 'rejected' && (
                <div className="bg-red-50 border border-red-200 rounded p-2 mt-2">
                  <p className="text-xs text-red-800">
                    ❌ Refund request was not approved. If you have questions,
