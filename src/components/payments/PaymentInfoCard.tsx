...
export default function PaymentInfoCard({ orderId, orderPaymentMethod }: PaymentInfoCardProps) {
            ...
            <div className="border rounded-lg p-4 bg-gray-50">
               <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                     {getPaymentMethodIcon(latestPayment.payment_method || orderPaymentMethod)}
                     <span className="font-medium text-sm">
                        {getPaymentMethodName(latestPayment.payment_method || orderPaymentMethod)}
                     </span>
                  </div>
                  <div className="flex items-center space-x-2">
