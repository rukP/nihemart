export const rw: Record<string, string> = {
   ...
   "products.more":
      "Kugira ngo umenye byinshi kuri iki gicuruzwa, reba iyi video",
   ...
   "cart.added": "Byongewe mu gatebo",
   "cart.removed": "Byakuwe mu gatebo",
   "cart.help":
   ...
   "payment.method.cash_on_delivery.name": "Ishyura bikugezeho",
   ...
   "checkout.processing": "Komande iri koherezwa...",
   ...
   "checkout.ordersDisabled":
      "Gutanga komande byahagaritswe. Mwongere mugerageze mukanya.",
   ...
   "thankYou.visitorTitle": "Ikaze Kuri NiheMart!",
   "thankYou.visitorMessage":
      "Twishimiye kubabona kuri NiheMart! Kugira ngo mugure ibicuruzwa byacu,  mujye kuri page y'ibicuruzwa.",
   "thankYou.shopNow": "Gura Nonaha →",
   ...
   "orders.transportOnly": "Transport Gusa",
   "orders.transportOnlyConfirm": "Emeza Transport Gusa",
   "orders.transportOnlyTitle": "Emeza Transport Gusa",
   "orders.transportOnlyDescription":
      "Ibi bizagira uruganda ariko tuzakomeza kwakira transport fee.\n\nNibizaba:\n• Status y'uruganda → Yagabanijwe\n• Igiciro cy'ibicuruzwa → Cya zero\n• Transport fee → Kizakomeza kandi kwongerwa ku rider earnings\n• Stock → Ntibizongerwa (ibicuruzwa ntibiboneka nk'ibagurwe)\n\nIki gikorwa ni cyo gusa kandi ntibishobora guhindurwa.",
