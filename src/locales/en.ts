export const en: Record<string, string> = {
  ...
  "admin.timeFilter.allTime": "All time",
  "admin.timeFilter.today": "Today",
  "admin.timeFilter.custom": "Custom range",
  "admin.timeFilter.apply": "Apply",
  "admin.timeFilter.clear": "Clear",
  "admin.timeFilter.close": "Close",
  "admin.timeFilter.label": "Time filter",
  ...
  "thankYou.visitorTitle": "Thank You for Coming to NiheMart!",
  "thankYou.visitorMessage":
    "We're glad you're here! To place an order and experience our amazing products, please visit our products page.",
  "thankYou.shopNow": "Shop Now →",
  ...
  "orders.transportOnly": "Transport Only",
  "orders.transportOnlyConfirm": "Confirm Transport Only",
  "orders.transportOnlyTitle": "Confirm Transport Only",
  "orders.transportOnlyDescription": "This will cancel the order but keep the transport fee.\n\nWhat happens:\n• Order status → CANCELLED\n• Product total → Zeroed\n• Transport fee → Kept and added to rider earnings\n• Stock → NOT restored (products not considered sold)\n\nThis action is final and cannot be undone.",
