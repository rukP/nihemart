   ...
   useEffect(() => {
         ...
         try {
            ...
            if (user?.id) {
               try {
                  ...
                  console.error(
                     "Failed to fetch user-specific notifications:",
                     e,
                  );
               }
            }
            ...
            if (hasRole && hasRole("rider") && user?.id) {
               try {
                  ...
                  console.error("Failed to fetch rider notifications:", e);
               }
            }
      ...
      const handleOnline = () => {
         try {
            ...
            console.error("Failed to re-connect Socket.IO on online:", e);
         }
      };
      ...
      const handleRealtimeRow = (row: any) => {
         ...
         if (recipientRole === "admin") {
            console.debug(
               "[NotificationsContext] Admin notification received:",
               {
         ...
         if (recipientRole === "rider") {
            console.debug(
               "[NotificationsContext] Rider notification received:",
               {
                  notificationId: row?.id,
                  recipientRole,
                  recipientUser,
